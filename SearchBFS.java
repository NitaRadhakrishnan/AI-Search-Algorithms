//It uses the BFS search and prints the nodes in the order they are expanded and visited.
...
public class SearchBFS
{
	public Map<String, ArrayList<String>> map;
        ...
        {
//		System.out.println(src_City+","+dest_City);
	    insert(src_City);
		insert(dest_City);
	...
	public ArrayList<String> get_Neighbours(String city) 
        {
	...
	public HashMap<String, ArrayList<String>> bfs(String src_City, String dest_City) 
        {
...
//			System.out.println(last);
			...
			if (visited.indexOf(last) == -1) visited.add(last);	
                        ...
                        ArrayList<String> neighbours = get_Neighbours(last);
			
                        for (String n : neighbours) 
                        {
				         if (visited.indexOf(n) == -1) 
							{
								ArrayList<String> newpath = (ArrayList) path.clone();
								newpath.add(n);
								q.add(newpath);	
				}
			}
	...
	public void print(HashMap<String, ArrayList<String>> h) 
		...
		System.out.println("The path to reach "+path.get(0)+ " from "+path.get(path.size()-1)+" is :\n");
